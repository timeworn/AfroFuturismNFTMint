<template>
  <section class="sec-main-top">
    ...
    <div
      ...
      class="connect-image-content"
    >
      <img class="img-fluid" src="../assets/img/metamask.png" />
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="main-wrapper-to-counter">
              <h2>AfroFuturism</h2>
              <p>
                Nullam vehicula, dolor et ornare pellentesque, turpis massa auc
              </p>
            </div>
            <div class="box-counter-1">
              ...
              <button @click="mint" type="button" class="btn btn-custom-mint">
                mint
              </button>
            </div>
          </div>
...
export default {
  ...
  computed: {
    ...
    getTotalPrice() {
      if (this.$store.state.afroFuturism.price > 0)
        return BigNumber(
          this.$store.state.afroFuturism.price * this.count
        ).shiftedBy(-18);
      return BigNumber(0);
    },
    hasMessage() {
  ...
  methods: {
    ...
    getUnlockTime() {
      ...
      var dayString;
      if (daysDifference < 10) dayString = "0" + daysDifference.toString();
      else dayString = daysDifference.toString();

      difference -= daysDifference * 1000 * 60 * 60 * 24;

      var hoursDifference = Math.floor(difference / 1000 / 60 / 60);
      var hourString;
      if (hoursDifference < 10) hourString = "0" + hoursDifference.toString();
      else hourString = hoursDifference.toString();
      ...
      else minutesString = minutesDifference.toString();
      ...
      else secondString = secondDifference.toString();
